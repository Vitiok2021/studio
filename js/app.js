(() => {
    ...
    function menuInit() {
        if (document.querySelector(".menu__action")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".menu__action")) {
                bodyLockToggle();
    ...
    function initSliders() {
        if (document.querySelector(".other-projects__slider")) new swiper_core_Swiper(".other-projects__slider", {
            ...
            loop: true,
            pagination: {
                el: ".swiper-actions-other-projects__bullets",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-actions-other-projects__prev",
                nextEl: ".swiper-actions-other-projects__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
    ...
    function imagesinit() {
        const images = document.querySelectorAll(".projects__item");
